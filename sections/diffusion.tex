\section*{4. Repeating original experiments with LLaDA-8B}

\subsection*{Problem \& Approach}
We compare a traditional autoregressive model to LLaDA, a discrete diffusion language model, to see how non-sequential generation affects mathematical reasoning. We evaluate LLaDA-8B by denoising fully masked sequences of length $N$ across varying diffusion steps $T \in \{8, 16, 32, 64\}$, where the number of tokens unmasked per step follows a linear schedule $k_t \approx \lfloor N/T \rfloor$.
