...
The goal is to determine if renaming alien operators to semantic strings (e.g., \texttt{combine}) or designed character strings affects the model's ability to reason. We evaluate zero-shot robustness by replacing the original alien operator names with four obfuscation schemes:
\begin{itemize}
